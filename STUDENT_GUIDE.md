# Student Guide: fleet-midi-bass

_Learn how the bass agent works and how to use it._

---

## What You'll Learn

1. What the bass musical concept is
2. How ternary decomposition applies to bass
...
```bash
curl -s http://localhost:2175/health | python3 -m json.tool
```
...
```bash
curl -s -X POST http://localhost:2175/agent \
